...
<div
    class="grid grid-cols-2 m-4 p-4 bg-yellow-300/90 max-w-[30rem] min-w-[20rem] slanted-corners"
>
    {#each recommendation.entry as subRecommendation}
        <div class="p-2 text-xl font-bold relative">
